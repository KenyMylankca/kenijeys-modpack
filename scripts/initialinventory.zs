mods.initialinventory.InvHandler.addStartingItem(<iceandfire:sheep_helmet>, 39);
mods.initialinventory.InvHandler.addStartingItem(<iceandfire:sheep_chestplate>, 38);
